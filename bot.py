...
class CustonmHelpCommand(commands.HelpCommand):
    ...
    async def send_bot_help(self, mapping):
        ...
        embed=discord.Embed(title="~ :book:指 令 教 學 文 件 ~", description="ヽ(ヅ)ノ感謝使用Uto-212class,\n希望能幫助到你!有任何問題都可以查看 [說明文件](https://utoclass.000webhostapp.com/) 哦!", color=0x00ff64, timestamp=self.get_destination().last_message.created_at)
...
bot = commands.Bot(command_prefix='*',help_command=CustonmHelpCommand(),intents=intents)
